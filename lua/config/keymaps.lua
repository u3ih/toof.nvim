...
map("n", "<Leader>cfn", "<cmd>let @+ = expand(\"%\")<CR><cmd>echo 'File name copied!'<CR>", { desc = "Copy File Name" })
map("n", "<Leader>cfp", "<cmd>let @+ = expand(\"%:p\")<CR><cmd>echo 'File path copied!'<CR>", { desc = "Copy File Path" })
